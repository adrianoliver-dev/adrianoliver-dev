            ...
            <div className="p-4 border-b border-[var(--color-border)] flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2 py-1 font-mono text-[10px] uppercase tracking-widest border rounded transition-colors hover:border-[var(--color-accent)] hover:text-[var(--color-accent)]"
                ...
                <button 
                  onClick={() => setIsOpen(false)}
                  className="p-1.5 rounded transition-colors hover:text-[var(--color-accent)]"
              ...
              {showScrollButton && (
                <div className="sticky bottom-2 flex justify-end pr-2">
                  <button
                    ...
                    className="p-2 rounded-full border shadow-lg transition-all hover:border-[var(--color-accent)] hover:text-[var(--color-accent)]"
                    style={{
